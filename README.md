...
```shell
> dotnet new install Toolbelt.AspNetCore.Blazor.Minimum.Templates::10.0.103.1
```

If you use .NET SDK **ver.6**, please enter the following command to install the project templates.

```shell
> dotnet new -i Toolbelt.AspNetCore.Blazor.Minimum.Templates::10.0.103.1
```
...
`-f`, `--framework` {`net6.0`, `net7.0`, `net8.0`, `net9.0`, or `net10.0`} |  The target framework for the project.
